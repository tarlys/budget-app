...
function Form() {
  ...
  let { price, count, summary, id, date, username, applicationType, company, unit, place, type, applicationName, spareParts, month, needless, provider, comment, status } = formData
  ...
  // const usernameHandler = (e: any) => setUsername(e.target.value)
  ...
  useEffect(() => {
    setFormData((prevState) => ({ ...prevState, summary: count * price }))
  }, [price, count])
    ...
    <>
      <form className=''>
        <div className='grid md:grid-cols-3 md:gap-6'>
          <div className='mb-6'>
            <label htmlFor='id-number' className='block mb-2 text-sm font-medium text-gray-900 dark:text-white'>
              Номер заявки
            </label>
            <input type='text' id='id-number' name='id-number' className='block w-full p-2 text-gray-900 border border-gray-300 rounded-lg bg-gray-50 sm:text-xs focus:ring-blue-500 focus:border-blue-500 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500' placeholder='Номер заявки' disabled />
          </div>
          ...
          <div className='mb-6'>
            ...
            <input type='date' id='date' name='date' className='block w-full p-2 text-gray-900 border border-gray-300 rounded-lg bg-gray-50 sm:text-xs focus:ring-blue-500 focus:border-blue-500 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500' disabled />
          </div>
          ...
          <div className='mb-6'>
            ...
            <input type='text' id='username' name='username' className='block w-full p-2 text-gray-900 border border-gray-300 rounded-lg bg-gray-50 sm:text-xs focus:ring-blue-500 focus:border-blue-500 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500' placeholder='Ваше імя та прізвище' value={username} onChange={onChange} required />
          </div>
        </div>
        ...
        <div className='grid md:grid-cols-3 md:gap-6'>
          <div className='mb-6'>
            ...
            <select id='application-type' name='application-type' value={applicationType} onChange={onChange} className='bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500' required>
          ...
          <div className='mb-6'>
            ...
            <select id='companies' name='companies' value={company} onChange={onChange} className='bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500' required>
          ...
          <div className='mb-6'>
            ...
            <select id='unit' name='unit' value={unit} onChange={onChange} className='bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500' required defaultValue='Виберіть відділ до якого відноситься заявка'>
        ...
        <div className='mb-6'>
          ...
          <input type='text' name='text' value={applicationName} onChange={onChange} id='application-name' className='block w-full p-2 text-gray-900 border border-gray-300 rounded-lg bg-gray-50 sm:text-xs focus:ring-blue-500 focus:border-blue-500 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500' placeholder='Найменування позиції яка потрібна' required />
        </div>

        <div className='flex items-center mb-4'>
          <input id='spare-parts' name='spare-parts' type='checkbox' checked={spareParts} onChange={onChange} className='w-4 h-4 text-blue-600 bg-gray-100 border-gray-300 rounded focus:ring-blue-500 dark:focus:ring-blue-600 dark:ring-offset-gray-800 dark:focus:ring-offset-gray-800 focus:ring-2 dark:bg-gray-700 dark:border-gray-600' />
        ...
        <div className='grid md:grid-cols-3 md:gap-6'>
          <button type='button' onClick={onDraftButton} className='text-gray-900 bg-white border border-gray-300 focus:outline-none hover:bg-gray-100 focus:ring-4 focus:ring-gray-200 font-medium rounded-lg text-sm px-5 py-2.5 mr-2 mb-2 dark:bg-gray-800 dark:text-white dark:border-gray-600 dark:hover:bg-gray-700 dark:hover:border-gray-600 dark:focus:ring-gray-700'>
            В чернетку
          </button>

          <button type='submit' onClick={onSubmitButton} className='focus:outline-none text-white bg-green-700 hover:bg-green-800 focus:ring-4 focus:ring-green-300 font-medium rounded-lg text-sm px-5 py-2.5 mr-2 mb-2 dark:bg-green-600 dark:hover:bg-green-700 dark:focus:ring-green-800'>
            На затвердження
          </button>

          <button type='button' onClick={onDeleteButton} className='focus:outline-none text-white bg-red-700 hover:bg-red-800 focus:ring-4 focus:ring-red-300 font-medium rounded-lg text-sm px-5 py-2.5 mr-2 mb-2 dark:bg-red-600 dark:hover:bg-red-700 dark:focus:ring-red-900'>
            Видалити
          </button>
        </div>
      </form>
