    ...
    <div className='relative shadow-md sm:rounded-lg'>
      {user?.isAdmin && (
        <div className='grid gap-6 mb-6 md:grid-cols-5'>
          ...
          <button type='button' onClick={onExcelDownload} className='text-white bg-gray-800 hover:bg-gray-900 focus:outline-none focus:ring-4 focus:ring-gray-300 font-medium rounded-lg text-sm px-5 py-2.5 mr-2 mb-2 dark:bg-gray-800 dark:hover:bg-gray-700 dark:focus:ring-gray-700 dark:border-gray-700'>
            Завантажити excel
          </button>
          {/* </DownloadTableExcel> */}
        </div>
